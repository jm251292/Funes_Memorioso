...
public class Registro_Denuncia_Ente extends javax.swing.JFrame 
{
    Conexion conexion;
    String user;
    
    public Registro_Denuncia_Ente(String user) 
    {
        this.user=user;
    ...
    private void initComponents() {
        ...
        jRadioButton2.setBounds(440, 280, 130, 20);
        ...
        jLabel2.setText("Involucrar ente:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            conexion.preparardb();
            conexion.insertarDenunciaEnte(jTextField1.getText(), jTextArea1.getText(),jTextArea3.getText(),String.valueOf(jComboBox1.getSelectedItem()), (jRadioButton1.isSelected())?jRadioButton1.getText():jRadioButton2.getText(), Integer.parseInt(String.valueOf(jComboBox2.getSelectedItem())),user);
        }
